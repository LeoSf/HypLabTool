...
class QtImageViewer(QGraphicsView):
    ...
    def __init__(self):
        ...
        # Default directory path to search images
    ...
    def loadImageFromFile(self, fileName=""):
        ...
        if len(fileName) == 0:
            if QT_VERSION_STR[0] == '4':
                ...
                fileName, dummy = QFileDialog.getOpenFileName(self, "Open image file.",self.default_directory_path,"Image files (*.tif)")     # TODO: fix this implementation
    ...
    def setDefaultDirectoryPath(self, path):
        self.default_directory_path = path
    ...
    def cropImage(self, x, y, w, h):
        ...
        :return: QPixmax image
        """
        if self.hasImage():
            # dimensions of the current image
            img_w = self._pixmapHandle.pixmap().width()
            img_h = self._pixmapHandle.pixmap().height()
            ...
            return self._pixmapHandle.pixmap().copy(QRect(x1, y1, w, h))
        return None
